...
fn bindgen_test_layout_MIDIEventPacket() {
    ...
    assert_eq!(
        ...
        268usize,
        "Size of MIDIEventPacket"
    );
    assert_eq!(
        ::std::mem::align_of::<MIDIEventPacket>(),
        4usize,
        "Alignment of MIDIEventPacket"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).timeStamp) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDIEventPacket::timeStamp"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).wordCount) as usize - ptr as usize },
        8usize,
        "Offset of field: MIDIEventPacket::wordCount"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).words) as usize - ptr as usize },
        12usize,
        "Offset of field: MIDIEventPacket::words"
    );
}
#[repr(C)]
...
fn bindgen_test_layout_MIDIPacket() {
    ...
    assert_eq!(
        ...
        4usize,
        "Alignment of MIDIPacket"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).timeStamp) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDIPacket::timeStamp"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).length) as usize - ptr as usize },
        8usize,
        "Offset of field: MIDIPacket::length"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).data) as usize - ptr as usize },
        10usize,
        "Offset of field: MIDIPacket::data"
    );
}
#[repr(C)]
...
fn bindgen_test_layout_MIDIPacketList() {
    ...
    assert_eq!(
        ...
        272usize,
        "Size of MIDIPacketList"
    );
    assert_eq!(
        ::std::mem::align_of::<MIDIPacketList>(),
        4usize,
        "Alignment of MIDIPacketList"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).numPackets) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDIPacketList::numPackets"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).packet) as usize - ptr as usize },
        4usize,
        "Offset of field: MIDIPacketList::packet"
    );
}
#[repr(C)]
...
fn bindgen_test_layout_MIDISysexSendRequest() {
    ...
    assert_eq!(
        ...
        40usize,
        "Size of MIDISysexSendRequest"
    );
    assert_eq!(
        ::std::mem::align_of::<MIDISysexSendRequest>(),
        8usize,
        "Alignment of MIDISysexSendRequest"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).destination) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDISysexSendRequest::destination"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).data) as usize - ptr as usize },
        8usize,
        "Offset of field: MIDISysexSendRequest::data"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).bytesToSend) as usize - ptr as usize },
        16usize,
        "Offset of field: MIDISysexSendRequest::bytesToSend"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).complete) as usize - ptr as usize },
        20usize,
        "Offset of field: MIDISysexSendRequest::complete"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).reserved) as usize - ptr as usize },
        21usize,
        "Offset of field: MIDISysexSendRequest::reserved"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).completionProc) as usize - ptr as usize },
        24usize,
        "Offset of field: MIDISysexSendRequest::completionProc"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).completionRefCon) as usize - ptr as usize },
        32usize,
        "Offset of field: MIDISysexSendRequest::completionRefCon"
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_MIDISysexSendRequestUMP() {
    ...
    assert_eq!(
        ...
        40usize,
        "Size of MIDISysexSendRequestUMP"
    );
    assert_eq!(
        ::std::mem::align_of::<MIDISysexSendRequestUMP>(),
        8usize,
        "Alignment of MIDISysexSendRequestUMP"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).destination) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDISysexSendRequestUMP::destination"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).words) as usize - ptr as usize },
        8usize,
        "Offset of field: MIDISysexSendRequestUMP::words"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).wordsToSend) as usize - ptr as usize },
        16usize,
        "Offset of field: MIDISysexSendRequestUMP::wordsToSend"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).complete) as usize - ptr as usize },
        20usize,
        "Offset of field: MIDISysexSendRequestUMP::complete"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).completionProc) as usize - ptr as usize },
        24usize,
        "Offset of field: MIDISysexSendRequestUMP::completionProc"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).completionRefCon) as usize - ptr as usize },
        32usize,
        "Offset of field: MIDISysexSendRequestUMP::completionRefCon"
    );
}
...
fn bindgen_test_layout_MIDIObjectAddRemoveNotification() {
    ...
    assert_eq!(
        ...
        24usize,
        "Size of MIDIObjectAddRemoveNotification"
    );
    assert_eq!(
        ::std::mem::align_of::<MIDIObjectAddRemoveNotification>(),
        4usize,
        "Alignment of MIDIObjectAddRemoveNotification"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).messageID) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDIObjectAddRemoveNotification::messageID"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).messageSize) as usize - ptr as usize },
        4usize,
        "Offset of field: MIDIObjectAddRemoveNotification::messageSize"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).parent) as usize - ptr as usize },
        8usize,
        "Offset of field: MIDIObjectAddRemoveNotification::parent"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).parentType) as usize - ptr as usize },
        12usize,
        "Offset of field: MIDIObjectAddRemoveNotification::parentType"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).child) as usize - ptr as usize },
        16usize,
        "Offset of field: MIDIObjectAddRemoveNotification::child"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).childType) as usize - ptr as usize },
        20usize,
        "Offset of field: MIDIObjectAddRemoveNotification::childType"
    );
}
#[repr(C)]
...
fn bindgen_test_layout_MIDIObjectPropertyChangeNotification() {
    ...
    assert_eq!(
        ...
        24usize,
        "Size of MIDIObjectPropertyChangeNotification"
    );
    assert_eq!(
        ::std::mem::align_of::<MIDIObjectPropertyChangeNotification>(),
        8usize,
        "Alignment of MIDIObjectPropertyChangeNotification"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).messageID) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDIObjectPropertyChangeNotification::messageID"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).messageSize) as usize - ptr as usize },
        4usize,
        "Offset of field: MIDIObjectPropertyChangeNotification::messageSize"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).object) as usize - ptr as usize },
        8usize,
        "Offset of field: MIDIObjectPropertyChangeNotification::object"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).objectType) as usize - ptr as usize },
        12usize,
        "Offset of field: MIDIObjectPropertyChangeNotification::objectType"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).propertyName) as usize - ptr as usize },
        16usize,
        "Offset of field: MIDIObjectPropertyChangeNotification::propertyName"
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
fn bindgen_test_layout_MIDIIOErrorNotification() {
    ...
    assert_eq!(
        ...
        16usize,
        "Size of MIDIIOErrorNotification"
    );
    assert_eq!(
        ::std::mem::align_of::<MIDIIOErrorNotification>(),
        4usize,
        "Alignment of MIDIIOErrorNotification"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).messageID) as usize - ptr as usize },
        0usize,
        "Offset of field: MIDIIOErrorNotification::messageID"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).messageSize) as usize - ptr as usize },
        4usize,
        "Offset of field: MIDIIOErrorNotification::messageSize"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).driverDevice) as usize - ptr as usize },
        8usize,
        "Offset of field: MIDIIOErrorNotification::driverDevice"
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).errorCode) as usize - ptr as usize },
        12usize,
        "Offset of field: MIDIIOErrorNotification::errorCode"
    );
}
extern "C" {
